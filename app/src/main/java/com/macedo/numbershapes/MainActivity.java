        ...
        if(!numberField.getText().toString().isEmpty()){
            ...
            if(numberVerificator.isSquare()){
                if(numberVerificator.isTriangular()){
                    ...
                    message = numberVerificator.number + " ís square, but not triangular.";
                }
            } else {
                if(numberVerificator.isTriangular()){
                    message = numberVerificator.number + " ís triangular, but not square.";
                } else {
                    message = numberVerificator.number + " ís neither triangular nor square. :(";
                }
            }
